					...
					foreach($data as $key => $row){ ?>
					  <tr> 
						  ...
						  <td style="font-size: 18px;">
							...
							?>
								<a class="link-line-none" id="cancel_<?php echo @$row['id']; ?>_1" data-toggle="modal" data-target="#confirmCancel" id="confirmCancelModal" class="fancybox_share fancybox.iframe" href="#" title="ยกเลิกการกู้เงิน" onclick="cancel_loan('<?php echo @$row['id']; ?>','3')" style="<?php echo $display_1; ?>">
									<span style="cursor: pointer;color:red;" class="icon icon-times-circle-o"></span>
								</a>
								<a class="link-line-none" id="cancel_<?php echo @$row['id']; ?>_2" data-toggle="modal" data-target="#confirmCancel" id="confirmCancelModal" class="fancybox_share fancybox.iframe" href="#" title="ยกเลิกการยกเลิกการกู้เงิน" onclick="cancel_loan('<?php echo @$row['id']; ?>','2')" style="<?php echo $display_2; ?>">
