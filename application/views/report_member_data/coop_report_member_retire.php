    ...
    <div class="layout-content-body">
		...
		<div class="row gutter-xs">
			<div class="col-xs-12 col-md-12">
				...
				<form action="<?php echo base_url(PROJECTPATH.'/report_member_data/coop_report_member_retire_excel'); ?>" id="form1" method="GET">
				...
				<form action="<?php echo base_url(PROJECTPATH.'/report_member_data/coop_report_member_retire_excel'); ?>" id="form2" method="GET">
					<div class="form-group g24-col-sm-24">
						<div class="g24-col-sm-5 right">
							<h3>รายเดือน</h3>
						</div>
				...
				<form action="<?php echo base_url(PROJECTPATH.'/report_member_data/coop_report_member_retire_excel'); ?>" id="form3" method="GET">
					<div class="form-group g24-col-sm-24">
						<div class="g24-col-sm-5 right">
							<h3>รายปี</h3>
						</div>
...
<?php
$link = array(
    'src' => 'ci_project/assets/js/coop_report_member_retire.js',
