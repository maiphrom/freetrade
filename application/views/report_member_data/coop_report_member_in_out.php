    ...
    <div class="layout-content-body">
		...
		<div class="row gutter-xs">
			<div class="col-xs-12 col-md-12">
				...
				<form action="<?php echo base_url(PROJECTPATH.'/report_member_data/coop_report_member_in_out_excel'); ?>" id="form1" method="GET">
...
<?php
$link = array(
    'src' => 'ci_project/assets/js/coop_report_member_in_out.js',
