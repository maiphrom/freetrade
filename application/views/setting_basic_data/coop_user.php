...
<?php if(@in_array($_GET["do"] , array("add" , "edit") ) ) {
	...
	<div class="col-md-6 col-md-offset-3">
		...
		<form data-toggle="validator" method="post" action="<?php echo base_url(PROJECTPATH.'/setting_basic_data/coop_user_save'); ?>" class="form form-horizontal">
			<input type="hidden" name="user_id" value="<?php echo $user_id; ?>"/>
			<div class="form-group">
				<label class="col-sm-3 control-label" for="employee_id">รหัสพนักงาน</label>
				<div class="col-sm-9">
					<input type="text" id="employee_id" name="employee_id" class="form-control m-b-1" value="<?php echo @$row["employee_id"]; ?>" required title="กรุณาป้อนรหัสพนักงาน" onchange="search_employee_id()">
				</div>
			</div>
			<div class="form-group">
...
<?php
$link = array(
    'src' => 'ci_project/assets/js/coop_user.js',
