...
<?php }else{ ?>
			...
			<h1 class="text-center m-t-1 m-b-1"> <?php echo  (!empty($id)) ? "แก้ไขสาขา" : "เพิ่มสาขา" ; ?></h1>
         ...
         <input name="bank_id"  type="hidden" value="<?php echo @$_GET['bank_id']; ?>" >
                ...
                <?php } ?>
                  ...
                  <div class="form-group text-center">
                    ...
                    <a href="?bank_id=<?php echo @$bank_id; ?>"><button class="btn btn-danger min-width-100" type="button">ยกเลิก</button></a>
                  </div>
...
<?php
$link = array(
    'src' => 'ci_project/assets/js/coop_bank_branch.js',
