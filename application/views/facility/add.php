...
<h1 style="margin-bottom: 0">ลงทะเบียนครุภัณฑ์</h1>
            ...
            <form data-toggle="validator" method="post" action="<?php echo base_url(PROJECTPATH.'/facility/save_add'); ?>" class="g24 form form-horizontal" enctype="multipart/form-data" autocomplete="off" id="myForm">
                ...
                <div class="m-t-1">
                    ...
                    <div class="g24-col-sm-20">
						...
						<div class="form-group">
                            <label class="g24-col-sm-3 control-label">ชื่อครุภัณฑ์ </label>
                    ...
                    <div class="g24-col-sm-4">
                        ...
                        <div class="g24-col-sm-24 m-b-1 text-right">
                            <div class="mem_pic" style="margin-bottom:20px;display: block;margin: 0 auto;">								
								<img id="store_pic" src="<?php echo base_url(); ?>ci_project/assets/uploads/facility/<?php echo empty($data['store_pic']) ? "default.png" : $data['store_pic']; ?>" alt="" />								
						...
						<table class="table table-bordered table-striped table-center">
							...
							if(!empty($row)){
								foreach(@$row as $key => $value){ ?>
									<tr>
										<td style="width: 80px;"><input type="checkbox" id="store_id[<?php echo @$value['store_id'];?>]" name="store_id[<?php echo @$value['store_id'];?>]" value="<?php echo @$value['store_id'];?>"></td>
										<td style="width: 80px;"><?php echo @$j++; ?></td>
										<td style="width: 20%;"><?php echo @$value['store_code']; ?></td>
										<td><?php echo @$value['store_serial']; ?></td>
										<td style="width: 80px;">
											<span class="text-edit" onclick="add_serial('<?php echo @$value['store_id'] ?>','<?php echo @$store_id?>','<?php echo @$value['store_serial']?>')">แก้ไข</span>
											|
            ...
            <div class="modal-body">
				<form method="post" action="?" class="g24 form form-horizontal" enctype="multipart/form-data" autocomplete="off" id="form_quantity">
					...
					<div class="form-group">						
						...
						<button type="button" onclick="check_quantity()" class="btn btn-primary min-width-100">
							<span class="icon icon-save"></span>
							บันทึก
						</button>
					</div>					
            ...
            <div class="modal-body">
				<form method="post" action="?" class="g24 form form-horizontal" enctype="multipart/form-data" autocomplete="off" id="form_quantity">
					...
					<div class="form-group">						
						...
						<button type="button" onclick="check_serial()" class="btn btn-primary min-width-100">
							<span class="icon icon-save"></span>
							บันทึก
						</button>
					</div>					
...
$link = array(
    'src' => 'ci_project/assets/js/facility_add.js',
    'type' => 'text/javascript'
);
echo script_tag($link);
?>