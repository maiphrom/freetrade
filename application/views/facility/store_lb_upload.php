<?php
	...
	define("PATH", $_SERVER["DOCUMENT_ROOT"]."/ci_project/assets");
...
<head>
	...
	<?php
	$link = array(
		'src' => 'ci_project/assets/js/jquery-1.10.2.min.js',
		'type' => 'text/javascript'
	);
	echo script_tag($link);
	$link = array(
		'src' => 'ci_project/assets/js/jquery-migrate-1.2.1.js',
		'type' => 'text/javascript'
	);
	echo script_tag($link);
	$link = array(
	...
	$link = array(
		'src' => 'ci_project/assets/js/jquery.Jcrop.js',
		'type' => 'text/javascript'
	);
	echo script_tag($link);
	$link = array(
		'href' => 'ci_project/assets/css/jquery.Jcrop.css',
		'rel' => 'stylesheet',
		'type' => 'text/css'
	);
	echo link_tag($link);
