<div class="layout-content">
    <div class="layout-content-body">
		...
		<h1 style="margin-bottom: 0">รายงานสินเชื่อแยกประเภท</h1>
		<?php $this->load->view('breadcrumb'); ?>
		<div class="row gutter-xs">
			<div class="col-xs-12 col-md-12">
				<div class="panel panel-body" style="padding-top:0px !important;">
				<form action="<?php echo base_url(PROJECTPATH.'/report_loan_data/coop_report_loan_normal_excel'); ?>" id="form1" method="GET">
					...
					<div class="form-group g24-col-sm-24">
						<label class="g24-col-sm-6 control-label right"> ประเภทสินเชื่อ </label>
				...
				<form action="<?php echo base_url(PROJECTPATH.'/report_loan_data/coop_report_loan_normal_excel'); ?>" id="form2" method="GET">
					<div class="form-group g24-col-sm-24">
						<div class="g24-col-sm-5 right">
							<h3>รายเดือน</h3>
						</div>
				...
				<form action="<?php echo base_url(PROJECTPATH.'/report_loan_data/coop_report_loan_normal_excel'); ?>" id="form3" method="GET" target="_blank">
					<div class="form-group g24-col-sm-24">
						<div class="g24-col-sm-5 right">
							<h3>รายปี</h3>
						</div>
...
$link = array(
    'src' => 'ci_project/assets/js/coop_report_loan.js',
