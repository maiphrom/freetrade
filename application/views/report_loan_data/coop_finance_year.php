				...
				<div class="panel panel-body" style="padding-top:0px !important;">
					...
					<div class="form-group g24-col-sm-24" style="margin-top:20px;">
						...
						<div class="g24-col-sm-10">
							<a id="link_1" href="<?php echo base_url(PROJECTPATH.'/report_loan_data/coop_finance_year_report?year='.(date('Y')+544)); ?>" target="_blank"><button type="button" class="btn btn-primary" style="width:100%">รายละเอียดยอดลูกหนี้คงเหลือ</button></a>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	function change_month_year(){
		...
		$('#link_1').attr('href', base_url+'report_loan_data/coop_finance_year_report?year='+year);
	}
</script>
