        ...
        <div class="col-xs-12 col-md-12">
				...
				<div class="g24-col-sm-24">
					<div class="form-group g24-col-sm-8">
						...
						<div class="g24-col-sm-14">
							<input class="form-control" type="text" value="<?php echo number_format($count_share,2); ?>"  readonly>
						</div>
					</div>
					<div class="form-group g24-col-sm-8">
			  ...
			  <div class="g24-col-sm-24">
				  <div class="form-group g24-col-sm-8">
						...
						<div class="g24-col-sm-14">
							<input class="form-control" type="text" value="<?php echo number_format($share_per_month,2); ?>" readonly>
						</div>
                  </div>
				  ...
				  <div class="form-group g24-col-sm-8">
						<div class="g24-col-sm-24">
						<button class="btn btn-primary" onclick="return check_form()"><span class="icon icon-plus-square-o"></span> เพิ่ม/ลดหุ้น</button>
						</div>
                  </div>
      ...
      <div class="modal-content">
		...
		<input type="hidden" name="member_id" value="<?php echo $member_id; ?>">
			<div class="form-group g24-col-sm-24" style="font-size:18px;">
				<p class="g24-col-sm-10">เพิ่ม/ลดส่งหุ้นเป็นเดือนละ</p>
			...
			<div class="form-group g24-col-sm-24">
				<p class="g24-col-sm-10" style="font-size:18px;">เพิ่ม/ลดส่งหุ้นเป็นเดือนละ</p>
...
<script>
 ...
 function check_form(){
	 ...
	 if('<?php echo $member_id; ?>'==''){
		...
		, function(result){
			if(result!='NOT FOUND'){
				alert_text += 'การเพิ่มหรือลดหุ้นทำได้เพียงปีละ 1 ครั้งเท่านั้น<br>ท่านทำรายการล่าสุดเมื่อ '+result+'<br>\n';
			}
			if(alert_text == ''){
