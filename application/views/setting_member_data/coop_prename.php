...
<?php }else{ ?>
			...
			<div class="col-md-6 col-md-offset-3">
				...
				<h1 class="text-center m-t-1 m-b-1"> <?php echo  (!empty($id)) ? "แก้ไขรายการ" : "เพิ่มรายการ" ; ?></h1>
				...
				<div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9 m-b-1">
                      <div class="radio">
                        <label>
                          <input type="radio" name="sex" id="sex1" value="M" required <?php echo (@$row['sex'] == "M") ? "checked" : "" ; ?>> ขาย
                        </label>
                        <label>
...
<?php
$link = array(
    'src' => 'ci_project/assets/js/coop_prename.js',
