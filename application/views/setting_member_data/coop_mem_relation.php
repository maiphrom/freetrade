...
<?php }else{ ?>
			...
			<div class="col-md-6 col-md-offset-3">
				...
				<h1 class="text-center m-t-1 m-b-1"> <?php echo  (!empty($id)) ? "แก้ไขความสัมพันธ์ผู้รับโอน" : "เพิ่มความสัมพันธ์ผู้รับโอน" ; ?></h1>
...
<?php
$link = array(
    'src' => 'ci_project/assets/js/coop_mem_relation.js',
