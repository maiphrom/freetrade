    ...
    <div class="navbar navbar-default">
        <div class="navbar-header">
            <a class="navbar-brand navbar-brand-center" href="/">
                <span style="font-size:1.5em;font-family: 'upbean';letter-spacing:3px;font-weight:bold;">FreeTrade</span>
            </a>
        ...
        <div class="navbar-toggleable">
            <nav id="navbar" class="navbar-collapse collapse">
              ...
              <span class="bars">
                ...
                <button class="navbar-account-btn" data-toggle="dropdown" aria-haspopup="true" style="margin-top: 5px;font-size: 20px;font-family: upbean;">
                  ...
                  <span class="visible-xs-block">
                    ...
                    <li class="dropdown hidden-xs" id="dropdown_li" open_now="false">
                        <button class="navbar-account-btn" id="dropdown_btn" data-toggle="dropdown" aria-haspopup="true" >
                            <img class="rounded" width="36" height="36" src="<?php echo PROJECTPATH; ?>/assets/images/member/1.jpg" alt=""> <?php echo $_SESSION['USER_NAME']; ?>
                            <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a href="<?php echo PROJECTPATH; ?>/main_menu/profile">ข้อมูลส่วนตัว</a></li>
                            <li><a href="<?php echo PROJECTPATH; ?>/main_menu/logout">ออกจากระบบ</a></li>
                        </ul>
                    </li>
                    <script>
                                    ...
                                    foreach(@$menu["submenus"] as $submenu) {
                                        ...
                                        if(chk_permission($submenu["id"], NULL, NULL, $user, $permissions)) {
                                            ...
                                            <li class="sidenav-item<?php if($start_menu_id != 0 && (get_menu_id(array($submenu), $current_path) != -1 || get_menu_id($submenu["submenus"], $current_path) != -1)) { ?><?php if(!empty($submenu["submenus"])) { ?> has-subnav<?php } ?> open<?php } ?><?php if($submenu["url"] == $current_path) { ?> active<?php } ?>">
                                                <a href="<?php echo @$submenu["url"]; ?>" <?php if(@$submenu["hidden"]=='hidden'){ echo "style='display:none'"; }?> aria-haspopup="true">
                                                    ...
                                                    <ul class="sidenav-subnav collapse">
                                                        <?php foreach($submenu["submenus"] as $submenu2) { ?>
                                                            <?php if(chk_permission($submenu2["id"], NULL, NULL, $user, $permissions)) { ?>
                                                                <li<?php if($submenu2["url"] == $current_path) { ?> class="active"<?php } ?>><a href="<?php echo $submenu2["url"]; ?>"><?php echo $submenu2["name"]; ?></a></li>
                                                            <?php } ?>
                                                        <?php } ?>
                                                    </ul>
                                                <?php } ?>
