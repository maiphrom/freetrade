				...
				<form action="<?php echo base_url(PROJECTPATH.'/setting_facility_data/facility_group_save'); ?>" method="POST" id="form1">
					<div id="choose_group" class="col-sm-12" style="padding-bottom: 10px;display:none;">
						<div class="col-sm-4" style="text-align:right;">
							<label style="font-size:14px;"><span>กลุ่มหลัก</span><label>
						</div>
						<div class="col-sm-4">
							<select class="form-control" id="main_group" name="main_group" onchange="change_group()">
					...
					<div id="choose_department" class="col-sm-12" style="padding-bottom: 10px;display:none;">
						<div class="col-sm-4" style="text-align:right;">
							<label style="font-size:14px;"><span>กลุ่มย่อย</span><label>
						</div>
					...
					<div class="col-sm-12" style="padding-bottom: 10px;">
						<div class="col-sm-4" style="text-align:right;">
							<label style="font-size:14px;"><span id="title_2">รหัสกลุ่ม</span><label>
						</div>
						<div class="col-sm-4">
							...
							<input type="text" class="form-control" id="facility_group_code" name="facility_group_code">
						</div>
					</div>
					<div class="col-sm-12" style="padding-bottom: 10px;">
						<div class="col-sm-4" style="text-align:right;">
							<label style="font-size:14px;"><span id="title_3">ชื่อกลุ่ม</span><label>
						</div>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="facility_group_name" name="facility_group_name">
						</div>
					</div>
...
<?php
$link = array(
    'src' => 'ci_project/assets/js/facility_group.js',
