...
<?php }else{ ?>
		...
		<h1 class="text-center m-t-1 m-b-1"><?php echo  (!empty($id)) ? "แก้ไขบุคลากร" : "เพิ่มบุคลากร" ; ?></h1>
			<form id='form_save' data-toggle="validator" novalidate="novalidate" action="<?php echo base_url(PROJECTPATH.'/setting_facility_data/personnel_save'); ?>" method="post">	
				...
				<div class="row">
					<label class="col-sm-3 control-label" for="personnel_name">ชื่อบุคลากร</label>
					<div class="col-sm-9">
				...
				<div class="row">
                    <label class="col-sm-3 control-label" for="department_id">หน่วยงานภายในที่สังกัด</label>
                    <div class="col-sm-9">
                      <div class="form-group">
...
<?php
$link = array(
    'src' => 'ci_project/assets/js/coop_personnel.js',
