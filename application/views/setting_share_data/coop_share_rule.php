...
<?php } ?>
	...
	<div id="inline1" style="width:550px;height:300px;overflow:auto;">
	  <div class="col-md-12">
			...
			<h1 class="text-center m-t-1 m-b-1"> เปลี่ยนแปลงมูลค่าหุ้น </h1>
			<h3 class="text-center m-t-1 m-b-1"> มูลค่าหุ้นปัจจุบัน  <span style="margin-left:30px;"> 
...
<?php } else { ?>
			...
			<div class="col-md-6 col-md-offset-3">
				...
				<h1 class="text-center m-t-1 m-b-1"> <?php echo  (!empty($id)) ? "แก้ไขเกณฑ์การถือหุ้นแรกเข้า" : "เพิ่มเกณฑ์การถือหุ้นแรกเข้า" ; ?></h1>
				...
				<form id='form_save' data-toggle="validator" novalidate="novalidate" action="<?php echo base_url(PROJECTPATH.'/setting_share_data/coop_share_rule_save'); ?>" method="post">	
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="form-control-2">เงินเดือนมากกว่า</label>
						<div class="col-sm-9">
					...
					<!-- <div class="form-group">
					<label class="col-sm-3 control-label" for="form-control-2">หุ้นแรกเข้า</label>
					<div class="col-sm-9">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="form-control-2">หุ้นรายเดือน</label>
						<div class="col-sm-9">
...
<?php
$link = array(
    'src' => 'ci_project/assets/js/coop_share_rule.js',
