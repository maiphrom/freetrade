		...
		$menus = array(
			...
			array("id" => 10, "name" => "ตั้งค่าระบบ", "url" => PROJECTPATH."/main_menu?section=admin", "icon" => "icon-cog", "img" => "admin.png", "submenus" => array(
				...
				array("id" => 104, "name" => "ระบบงานพัสดุ", "url" => PROJECTPATH."/main_menu?section=admin.facility_setting", "icon" => "icon-briefcase", "img" => "bank.png", "submenus" => array(
					...
					array("id" => 107, "name" => "กลุ่มพัสดุ", "url" => PROJECTPATH."/setting_facility_data/facility_group", "icon" => "", "img" => "list_code.png"),
					array("id" => 108, "name" => "ประเภทพัสดุ", "url" => PROJECTPATH."/setting_facility_data/facility_type", "icon" => "", "img" => "list_code.png"),
					array("id" => 109, "name" => "พัสดุหลัก", "url" => PROJECTPATH."/setting_facility_data/facility_main", "icon" => "", "img" => "list_code.png"),
					array("id" => 110, "name" => "เหตุผลการใช้งาน", "url" => PROJECTPATH."/setting_facility_data/usage_reason", "icon" => "", "img" => "list_code.png"),
					array("id" => 111, "name" => "วิธีการจัดซื้อ", "url" => PROJECTPATH."/setting_facility_data/means_purchase", "icon" => "", "img" => "list_code.png"),
					array("id" => 112, "name" => "ประเภทเงิน", "url" => PROJECTPATH."/setting_facility_data/type_money", "icon" => "", "img" => "list_code.png"),
					array("id" => 113, "name" => "หน่วยงานภายใน", "url" => PROJECTPATH."/setting_facility_data/department", "icon" => "", "img" => "list_code.png"),
					array("id" => 114, "name" => "บุคลากร", "url" => PROJECTPATH."/setting_facility_data/personnel", "icon" => "", "img" => "list_code.png"),
					array("id" => 115, "name" => "ร้านค้า", "url" => PROJECTPATH."/setting_facility_data/seller", "icon" => "", "img" => "list_code.png"),
					array("id" => 116, "name" => "ประเภทหลักฐาน", "url" => PROJECTPATH."/setting_facility_data/type_evidence", "icon" => "", "img" => "list_code.png"),
					array("id" => 117, "name" => "ประเภทหลักประกัน", "url" => PROJECTPATH."/setting_facility_data/type_guarantee", "icon" => "", "img" => "list_code.png"),
					array("id" => 118, "name" => "ค่าเสื่อมราคา", "url" => PROJECTPATH."/setting_facility_data/depreciation", "icon" => "", "img" => "list_code.png"),
				))
			)),
